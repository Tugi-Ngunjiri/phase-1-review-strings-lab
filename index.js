...
const Wm = 'Welcome to Flatbook, ';
const Cu = 'Grace Hopper';
const Wm= currentUser;
const Cu= 'Grace Hopper';
const Wm = 'Welcome to Flatbook, currentUser';
...
const welcomeMessage = 'Welcome to Flconst myNumber = 10;
